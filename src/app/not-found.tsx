...
export default function GlobalNotFoundPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center select-none bg-white dark:bg-[#09090f] text-black dark:text-white transition-colors duration-300">
